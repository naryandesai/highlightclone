...
function Matlab() {
  ...
  try{
    try {
      let email = getEmail()
        fetch("https://8wrro7by93.execute-api.us-east-1.amazonaws.com/ferret/charge/"+email+"&Programming with MATLAB for Engineers"+"&"+new Date().getTime())
        .then( res => res.text() )
        .then( data =>  {
          console.log(data)
        ...
        <Container>
          <Row>
            <Col className="ml-auto mr-auto text-center" md="8">
              ...
              <h4 className="title">ISBN: 0-9669601-6-7</h4>
            </Col>
          </Row>
        </Container>
      </div>
    ...
    <Col className="text-center ml-auto mr-auto" md = "2">
      <div className="send-button">
        <Button
          ...
          className="btn-round"
          align-items="center"
          onClick={() => startPurchase(6900, false, 'Programming with MATLAB for Engineers')}
          color="info"
          size="lg"
        >
          Purchase online edition for $69
        </Button>
        <Button
          block
          id='read'
          ...
          className="btn-round"
          align-items="center"
          onClick={ () => startPurchase(4000, true, 'Programming with MATLAB for Engineers') }
          color="info"
          size="lg"
        >
        ...
        <Button
          ...
          className="btn-round"
          align-items="center"
          onClick={ () => startPurchase(10900, true, 'Programming with MATLAB for Engineers')  }
          color="info"
          size="lg"
        >
          Purchase online and physical edition for $109
        </Button>
        ...
        <Button
          ...
          className="btn-round"
          align-items="center"
          onClick={ () => startPurchase(document.getElementById("coupon").value, true, 'Programming with MATLAB for Engineers') }
          color="info"
          size="lg"
        >
