    ...
    <Col className="text-center ml-auto mr-auto" md = "2">
      <div className="send-button">
        <Button
          ...
          className="btn-round"
          align-items="center"
          onClick={() => startPurchase(9900, false, 'Computational Methods for Chemical Engineers')}
          color="info"
          size="lg"
        >
        ...
        <Button
          ...
          className="btn-round"
          align-items="center"
          onClick={ () => startPurchase(13900, true, 'Computational Methods for Chemical Engineers')  }
          color="info"
          size="lg"
        >
